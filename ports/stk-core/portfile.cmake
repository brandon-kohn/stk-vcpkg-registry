...
vcpkg_cmake_install()
vcpkg_cmake_config_fixup(CONFIG_PATH share/stk)


file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug" "${CURRENT_PACKAGES_DIR}/lib")

configure_file(
    ${CMAKE_CURRENT_LIST_DIR}/stk-config.in.cmake
    ${CURRENT_PACKAGES_DIR}/share/stk/stk-config.cmake
    @ONLY
)
file(GLOB HEADER_FILES ${SOURCE_PATH}/stk/stk/*)
file(INSTALL ${HEADER_FILES} DESTINATION ${CURRENT_PACKAGES_DIR}/include/stk)
